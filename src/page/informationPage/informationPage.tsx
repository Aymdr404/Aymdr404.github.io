    ...
    return (
        <div className="informationPage">
            ...
            <section className="skill">
                ...
                <SkillDescription title="Python" description="Ayant utilisé python en tant que backend lors de mon alternance. J'ai pu apprendre toutes les facettes de cette technologie étant énormement utilisé par les entreprises" pourcentage={90} />
