...
const Experience: React.FC = () => {
    ...
    const events: TimelineEvent[] = [
        { status: 'Spartoo', date:'Septembre 2025 => Maintenant', color:'#ff1707ff', image:'logo_spartoo.png', info:'Développeur web PHP. Développement des applications interne utilisé par nos revendeurs' },
